...
| **Provenance** | bead claudepr-6b587922 (2026-09-25); binding design bead claudepr-a927ec0c; first-output credit bead claudepr-33fdf4ed; re-measured and re-pinned to 2.1.282 by claudepr-b590e46d; re-measured and re-pinned to 2.1.283 by claudepr-72d0ba4c (2026-09-26) |
...
claude 2.1.283 on 2026-09-26 (claudepr-72d0ba4c: two sandboxed PTY sessions
driven through claude-print itself, both replayed byte-identical to their
transcript files — no `result` record, compact JSON, the 2.1.282
